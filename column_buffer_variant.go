...
func writeValueFuncOfVariant(columnIndex int16, node Node) (int16, writeValueFunc) {
...
func writeValueFuncOfUnshreddedVariant(columnIndex int16, node Node) (int16, writeValueFunc) {
...
func writeValueFuncOfShreddedVariant(columnIndex int16, node Node) (int16, writeValueFunc) {
...
func writeShredded(columns []ColumnBuffer, levels columnLevels, startColumn int16, m *shreddedMatcher, v any) {
	if m.isPrimitive {
...
func writeShreddedObject(columns []ColumnBuffer, levels columnLevels, startColumn int16, m *shreddedMatcher, v any) {

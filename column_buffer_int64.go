...
func (col *int64ColumnBuffer) Less(i, j int) bool {
...
func (col *int64ColumnBuffer) writeValues(levels columnLevels, rows sparse.Array) {
	newValues := make([]int64, rows.Len())
	sparse.GatherInt64(newValues, rows.Int64Array())
